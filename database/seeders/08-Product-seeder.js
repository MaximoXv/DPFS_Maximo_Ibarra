    ...
    const products = [
      {
        ...
        description: "Abrigo de lana suave y cálido ideal para niños en invierno.",
        model: "LANA2025",
      ...
      },
      {
        ...
        description: "Chaqueta casual y moderna para adolescentes, perfecta para el otoño y la primavera.",
        model: "CA2025",
        price: getRandomInt(80000,200000),
        stock: getRandomInt(50, 120),
        visibility: 1,
      ...
      },
      {
        ...
        description: "Pantalón cómodo para ejercicio o descanso, ideal para adultos.",
        model: "DEPORTIVO2025",
        price: getRandomInt(80000,200000),
        stock: getRandomInt(50, 120),
        visibility: 1,
      ...
      },
      {
        ...
        description: "Vestido elegante para niñas, ideal para eventos especiales.",
        model: "VESTIDO2025",
        price: getRandomInt(80000,200000),
        stock: getRandomInt(50, 120),
        visibility: 1,
      ...
      },
      {
        ...
        description: "Sudadera con capucha, cómoda y versátil para adolescentes, perfecta para días fríos.",
        model: "SUDADERA2025",
        price: getRandomInt(80000,200000),
        stock: getRandomInt(50, 120),
        visibility: 1,
      ...
      },
      {
        ...
        description: "Chaqueta de cuero elegante y moderna, ideal para mujeres.",
        model: "CUERO2025",
        price: getRandomInt(80000,200000),
        stock: getRandomInt(50, 120),
        visibility: 1,
      ...
      },
      {
        ...
        description: "Botines de invierno resistentes y cómodos, ideales para hombres.",
        model: "BOTINES2025",
        price: getRandomInt(80000,200000),
        stock: getRandomInt(50, 120),
        visibility: 1,
      ...
      },
      {
        ...
        description: "Camiseta juvenil con diseño moderno y cómodo, ideal para adolescentes.",
        model: "CAMISETA2025",
        price: getRandomInt(80000,200000),
        stock: getRandomInt(50, 120),
        visibility: 1,
      ...
      },
      {
        ...
        description: "Pantalón de corte slim fit, perfecto para un look casual y elegante.",
        model: "SLIMFIT2025",
        price: getRandomInt(80000,200000),
        stock: getRandomInt(50, 120),
        visibility: 1,
      ...
      },
      {
        ...
        description: "Short cómodo y flexible, ideal para hacer deporte o descansar.",
      ...
      },
      {
        ...
        description: "Campera de plumas cálida y ligera, perfecta para el invierno de los más pequeños.",
        model: "PLUMAS2025",
        price: getRandomInt(80000,200000),
        stock: getRandomInt(50, 120),
        visibility: 1,
      ...
      },
      {
        ...
        description: "Suéter de lana suave y cálido, ideal para mujeres durante el invierno.",
        model: "SUETER2025",
        price: getRandomInt(80000,200000),
        stock: getRandomInt(50, 120),
        visibility: 1,
      ...
      },
      {
        ...
        description: "Pantalón cargo cómodo y práctico para hombres, ideal para cualquier ocasión.",
        model: "CARGO2025",
        price: getRandomInt(80000,200000),
        stock: getRandomInt(50, 120),
        visibility: 1,
      ...
      },
      {
        ...
        description: "Chaqueta de invierno resistente al frío, ideal para mujeres que aman el frío.",
        model: "CHAQUETA2025",
        price: getRandomInt(80000,200000),
        stock: getRandomInt(50, 120),
        visibility: 1,
      ...
      },
      {
        ...
        description: "Sudadera con divertido estampado para niñas, perfecta para invierno.",
        model: "SUDADERA2025",
        price: getRandomInt(80000,200000),
        stock: getRandomInt(50, 120),
        visibility: 1,
